...
mocha.describe('Response code to response message tests', () => {
  ...
  mocha.it('Chose group, original message text', async () => {
    ...
    const responseMessage =
      await utils.responseCodeToResponseMessage(responseCode, null, null, true);
