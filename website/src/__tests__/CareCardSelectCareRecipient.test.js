...
import * as CareCardSelectCareRecipientContainer from '../containers/CareCardSelectCareRecipientContainer';
...
describe('Get member list', () => {
  it('Get success', async () => {
    ...
    const stubState = { careCard: { selectCrMembers: stubSelectCrMembers } };
    ...
    const memberList = CareCardSelectCareRecipientContainer._getMemberList(stubState);
...
describe('Fetch group members', () => {
  it('Fetch success', async () => {
    ...
    const members =
      await CareCardSelectCareRecipientContainer._fetchGroupMembers(stubDispatchProps);
    chai.assert
...
describe('Handle click select', () => {
  it('Selected member is not new member', async () => {
    ...
    await CareCardSelectCareRecipientContainer
  ...
  it('Selected member is new member', async () => {
    const stubAuthUid = 'AUTH_UID';
    const stubActiveGroup = 'TEST_GROUP';
    const stubSelectedMember = constants.CARE_CARD_CR_CODE_NEW_MEMBER;
