...
export const FIREBASE_MESSAGING_SENDER_ID = '526818909048';
export const FIREBASE_PROJECT_ID = 'lumi-cares';
export const FIREBASE_STORAGE_BUCKET = 'lumi-cares.appspot.com';

// TODO(kai): Remove this and all references to it
export const MESSENGER_PSID_KAI = '1553889568038886';
